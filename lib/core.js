/* ============================================================
   ...
   WHAT LIVES WHERE (this matters the day your brother signs in):

     PERSONAL — moves to a per-user table
       APPRENTICE, OJT_SEED, CO_RATE_SEED, BOOKING_SEED, CLASS_SEED
       (imported from ./personal-data, which is gitignored — see
       lib/personal-data.example.js to set up your own copy)

     SHARED — same for everyone in Local 831, seeded once
       COMPANIES, RAW_MAY / RAW_JUNE / RAW_JULY, LEVELS, CATS_META, PAY, JATC
   ============================================================ */

export { APPRENTICE, CO_RATE_SEED, OJT_SEED, BOOKING_SEED, CLASS_SEED } from "./personal-data";
import { OJT_SEED } from "./personal-data";
...
/* ---------- EI companies & labor phone numbers (Local 831) ---------- */
export const COMPANIES = [
  { n: "All Exhibits Solutions", city: "Anaheim", st: "CA", tel: "6577065784", fm: "Austin Taylor" },
  { n: "Bachiero Event Services", city: "Torrance", st: "CA", tel: "3104650553", fm: "Kellie Bachiero" },
  { n: "Bird Rock Expo", city: "San Diego", st: "CA", tel: "8887942220", fm: "Adam Hurst" },
  { n: "Coastal International Con Svc", city: "Tustin", st: "CA", tel: "7146351200", fm: "Fred Blacksher" },
  { n: "CSI Worldwide", city: "Lake Elsinore", st: "CA", tel: "9514711011", fm: "Alex Hill V" },
  { n: "Curtin Conv. & Exposition Srvs", city: "San Francisco", st: "CA", tel: "4158837818", fm: "Ed Borrayo" },
  { n: "Customer Service I&D", city: "Oceanside", st: "CA", tel: "8018858894", fm: "Tom Casper" },
  { n: "CY Expo", city: "El Cajon", st: "CA", tel: "6192411797", fm: "Chad Young" },
  { n: "Czarnowski Display Serv", city: "Cypress", st: "CA", tel: "7147084947", fm: "Chris Bilauca" },
  { n: "Eagle Management Group", city: "San Clemente", st: "CA", tel: "7149845066", fm: "Trey Kadow" },
  { n: "EWI Worldwide", city: "Foothill Ranch", st: "CA", tel: "7144125267", fm: "T.J. Sylvia" },
  { n: "Exhibits On Time", city: "Mesa", st: "AZ", tel: "4802482445", fm: "Van Curry" },
  { n: "Expo Convention Contractors", city: "Placentia", st: "CA", tel: "7147156653", fm: "Doug Emerson" },
  { n: "Expo Labor Solutions", city: "Chula Vista", st: "CA", tel: "6196060967", fm: "Dung Dang" },
  { n: "Fern Expo", city: "Plymouth", st: "MA", tel: "7813141094", fm: "Scott Dobbins" },
  { n: "Freeman Expositions (LA)", city: "Anaheim", st: "CA", tel: "7142543401", fm: "David Valdez" },
  { n: "Freeman Expositions (SD)", city: "Anaheim", st: "CA", tel: "6574977545", fm: "Tony Mattox" },
  { n: "Galaxy Labor Force", city: "Anaheim", st: "CA", tel: "7025611001", fm: "Lou Genzano" },
  { n: "Global Experience Specialists (SD)", city: "Las Vegas", st: "NV", tel: "9518055547", fm: "Jose Sierra" },
  { n: "Global Experience Specialists (LA)", city: "Las Vegas", st: "NV", tel: "7027883341", fm: "Bryan Gaddie" },
  { n: "Global Experience Specialists (Spiro)", city: "Las Vegas", st: "NV", tel: "5623563762", fm: "Mathew Karedas" },
  { n: "Innovative Expo", city: "Thousand Palms", st: "CA", tel: "7603432555", fm: "Nick Grant" },
  { n: "International Expo Service", city: "Cerritos", st: "CA", tel: "5624748881", fm: "Anthony DiGiorgi" },
  { n: "Lancaster Management Services", city: "Whittier", st: "CA", tel: "7143568710", fm: "Kane Talauega" },
  { n: "Laser Exhibitor Service", city: "San Juan Capistrano", st: "CA", tel: "9492830620", fm: "James Jones" },
  { n: "McNabb Company", city: "Milford", st: "MI", tel: "7142776391", fm: "Mark Burrett" },
  { n: "Momentum Management", city: "Anaheim", st: "CA", tel: "7148862407", fm: "Tom Kearney" },
  { n: "Nirvana Expo Services", city: "San Diego", st: "CA", tel: "6197949039", fm: "Won Chae Matthew" },
  { n: "Nth Degree", city: "Anaheim", st: "CA", tel: "7145085199", fm: "Chris Wagoner" },
  { n: "Nuvista Event Services", city: "San Clemente", st: "CA", tel: "9495031610", fm: "Jon Friel" },
  { n: "Octane Group", city: "Las Vegas", st: "NV", tel: "5625514505", fm: "Anthony Morales" },
  { n: "On Location", city: "Stanton", st: "CA", tel: "7143313265", fm: "David Post" },
  { n: "Palladium Management", city: "Las Vegas", st: "NV", tel: "", fm: "Joel Holcomb" },
  { n: "San Diego Exhibitor Shw Sv", city: "El Cajon", st: "CA", tel: "8585529033", fm: "Jeron Harrison" },
  { n: "Shepard Exposition Services", city: "Ontario", st: "CA", tel: "9092127245", fm: "Daniel Budnic" },
  { n: "Sho-Link", city: "Huntington Beach", st: "CA", tel: "7145966679", fm: "Leandra Spontak" },
  { n: "Show Ready", city: "Rancho Cucamonga", st: "CA", tel: "9092359582", fm: "Randy Russo" },
  { n: "Show Services", city: "Springtown", st: "TX", tel: "2145005982", fm: "Jon Ford" },
  { n: "Skylink Show Services", city: "Lake Forest", st: "CA", tel: "", fm: "John Balderrama" },
  { n: "SoCal Convention Services", city: "Whittier", st: "CA", tel: "5625873711", fm: "Ted Leon" },
  { n: "Square Feet I&D", city: "Yorba Linda", st: "CA", tel: "6573638355", fm: "Emily Esparza" },
  { n: "Steele Tradeshow Services", city: "Blue Ash", st: "OH", tel: "7603607722", fm: "Rico Ibanez" },
  { n: "T3 Expo", city: "Las Vegas", st: "NV", tel: "9519656124", fm: "Edgar Borrayo" },
  { n: "Total Expo", city: "Carson", st: "CA", tel: "5622955006", fm: "Kevin Lecarner" },
  { n: "Tradeshow Services Network", city: "Riverside", st: "CA", tel: "7026883875", fm: "Eric Selmser" },
  { n: "Tricord Tradeshow Services", city: "Marina", st: "CA", tel: "3109477608", fm: "Steve Toshimitsu" },
  { n: "Tru Service Group", city: "Russell", st: "IL", tel: "6573638249", fm: "Sal Esparza" },
  { n: "Union Payroll Agency", city: "Rocklin", st: "CA", tel: "9166251420", fm: "Mathew Wright" },
  { n: "WC3", city: "Yorba Linda", st: "CA", tel: "7149832736", fm: "Donna McComb" },
  { n: "Wen Global Solutions", city: "Pico Rivera", st: "CA", tel: "7608286606", fm: "Gus Figueroa" },
  { n: "Willwork Inc.", city: "Corona", st: "CA", tel: "2134471611", fm: "Mario Riveros" },
  { n: "Xibit Solutions", city: "North Las Vegas", st: "NV", tel: "7023617502", fm: "Laura" },
  { n: "Xime Solutions Group", city: "Chino", st: "CA", tel: "9512840883", fm: "Albert Contreras" },
];
...
export function findCo(name) { return COMPANIES.find((c) => c.n === name) || null; }
export function matchCo(co, region) {
  ...
  if (up.indexOf("FREEMAN") !== -1) { const sd = region === "SD"; return { name: "Freeman Expositions", fm: sd ? "Tony Mattox (SD)" : "David Valdez (LA)", city: "Anaheim", tel: sd ? "6574977545" : "7142543401" }; }
  if (up === "GES" || up.indexOf("GLOBAL EXPERIENCE") !== -1) { const sd = region === "SD"; return { name: "Global Experience Specialists", fm: sd ? "Jose Sierra (SD)" : "Bryan Gaddie (LA)", city: "", tel: sd ? "9518055547" : "7027883341" }; }
  const alias = CO_ALIAS[up];
  if (alias) { const c = findCo(alias); if (c) return { name: c.n, fm: c.fm, city: c.city, tel: c.tel }; }
  const c2 = COMPANIES.find((c) => up.length >= 3 && c.n.toUpperCase().indexOf(up) !== -1);
...
export const JATC = {
  ...
  contacts: [
    { n: "Tiffanie Barron", tel: "7148944094", ext: "10", email: "tiffanie@local831training.org", sms: "3237152692" },
    { n: "Amanda Mejia", tel: "7148944094", ext: "20", email: "join831@local831training.org" },
  ],
};
...
export const CERTS = [
  { n: "CPR / First-Aid / AED", exp: "2028-01-08" },
  { n: "Forklift / Genie",      exp: "2028-09-17" },
  { n: "Scissor Lift",          exp: "2029-01-26" },
  { n: "OSHA 10",               exp: "2025-08-15" },
];

export const OJT_DEFAULT = { months: OJT_SEED };
